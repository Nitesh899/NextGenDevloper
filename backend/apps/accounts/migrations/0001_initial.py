    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('USER', 'User'), ('ADMIN', 'Admin')], default='USER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_type', models.CharField(choices=[('PHONE_LOGIN', 'Phone Login'), ('PHONE_REGISTER', 'Phone Registration'), ('PASSWORD_RESET', 'Password Reset')], max_length=30)),
